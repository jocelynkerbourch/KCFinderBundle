...
<script src="/admin/kcfinder/js/browser/joiner.php" type="text/javascript"></script>
<script src="/admin/kcfinder/js_localize.php?lng=<?php echo $this->lang ?>" type="text/javascript"></script>
